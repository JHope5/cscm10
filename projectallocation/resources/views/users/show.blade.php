...
<div class="row">
    ...
    <div class="col-md-3">
        @if((Auth::id() == $user->id) && ($user->role_id == 1 || $user->role_id == 2))
        ...
        {!! Html::linkRoute('students.edit', 'Update Preferences', array($user->id), array('class'=>'btn btn-primary btn-block')) !!}
        @endif
    </div>
    <div class="col-md-12">
        <hr>
                ...
                <tbody>
                    ...
                    <?php $proj = Project::where('code', $preference)->first();
                        ...
                        <tr>
                            ...
                            <td>{{ User::find(Project::find($projID)->lecturer_id)->email }}</td>
