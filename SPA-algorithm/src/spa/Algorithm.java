...
public class Algorithm {
	...
	public void runAllocation() {
		while(studentIsFreeWithNonEmptyList()) {
			...
			if(pj.isFull()) {
				...
				// to break the assignment
				for(int i = lk.getStudentIndex(sr) + 1; i < lk.getTotalPreferences(); i++) {
	...
	/*
	 * Getting a student who does not yet have a project,
	 * or returning null
	 */
	...
	/*
	 * Getting the lecturer who offers a project
	 */
